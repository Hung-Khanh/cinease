...
const HistoryTicket = () => {
  ...
  const data = [
    { key: '1', date: "11/06/2025", transactionId: "TX000001", description: "Movie ticket purchase", type: "add", points: 200 },
    { key: '2', date: "10/06/2025", transactionId: "TX000002", description: "Refreshments purchase", type: "add", points: 50 },
    { key: '3', date: "09/06/2025", transactionId: "TX000003", description: "Ticket refund points", type: "minus", points: 100 },
    { key: '4', date: "08/06/2025", transactionId: "TX000004", description: "Movie ticket purchase", type: "add", points: 300 },
    { key: '5', date: "07/06/2025", transactionId: "TX000005", description: "Movie ticket purchase", type: "add", points: 250 },
  ];
    ...
    <div className="history-ticket">
      ...
      <div className="summary">
        ...
        <Card className="summary-card">
          ...
          <div className="value"><span className="level-icon">👑</span> {membershipLevel}</div>
        </Card>
        <Card className="summary-card">
